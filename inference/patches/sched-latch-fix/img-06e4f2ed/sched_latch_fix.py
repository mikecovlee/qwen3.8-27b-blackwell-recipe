...
# (add_chunked_req appends it unconditionally — still true in 94602c9) and the quota
...
#
# Anchor moved: scheduler.py:3355 (5f55db35) -> scheduler.py:3887 (94602c9).
...
def _log(msg):
    print(f"[sched-latch-fix/06e4f2ed] {msg}", file=sys.stderr, flush=True)
